                    ...
                    children: [
                      ...
                      TextButton(
                        onPressed: () => _launchURL(
                          'https://github.com/KamaniasFaucet/sumcoin_flutter/blob/main/LICENSE',
                        ),
                        child: Text(
                          AppLocalizations.instance.translate(
                            'about_license',
                      ...
                      TextButton(
                        onPressed: () => _launchURL(
                          'https://github.com/KamaniasFaucet/sumcoin_flutter',
                        ),
                        child: Text(
                          AppLocalizations.instance.translate(
                            'about_view_source',
                      ...
                      TextButton(
                        onPressed: () => _launchURL(
                          'https://github.com/KamaniasFaucet/sumcoin_flutter/blob/main/data_protection.md',
                        ),
                        child: Text(
                          AppLocalizations.instance.translate(
